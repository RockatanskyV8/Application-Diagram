Essa aplicação tem por objetivo fazer uma demonstração intuitiva das organização do código fonte da aplicação, por exemplo onde cada frase está sendo chamada.
